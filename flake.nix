    ...
    in
    {
      ...
      nixosModules = {
        ...
        nixpkgs-rpi =
          ...
          import ./modules/nixpkgs-rpi.nix {
            inherit
              config
              lib
              pkgs
        ...
        default =
          ...
          import ./modules/raspberrypi.nix {
            inherit
              config
              lib
              pkgs
        ...
        raspberry-pi-4 = {
          base =
            ...
            import ./modules/raspberry-pi-4.nix {
              inherit
                config
                lib
                pkgs
        ...
        raspberry-pi-3 = {
          base =
            ...
            import ./modules/raspberry-pi-3.nix {
              inherit
                config
                lib
                pkgs
        ...
        raspberry-pi-02 = {
          base =
            ...
            import ./modules/raspberry-pi-02.nix {
              inherit
                config
                lib
                pkgs
      ...
      nixosConfigurations =
        ...
        in
        {
          ...
          rpi02-installer = self.lib.mkNixOSRPiInstaller [
            (
              {
                config,
                pkgs,
          ...
          rpi3-installer = self.lib.mkNixOSRPiInstaller [
            (
              {
                config,
                pkgs,
          ...
          rpi4-installer = self.lib.mkNixOSRPiInstaller [
            (
              {
                config,
                pkgs,
          ...
          rpi5-installer = self.lib.mkNixOSRPiInstaller [
            (
              {
                config,
                pkgs,
